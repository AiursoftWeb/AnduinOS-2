These frames were captured from an isolated QEMU AMD64 OVMF Secure Boot VM
running the distribution-signed shim and GRUB 2.14. The GRUB menu used the
AnduinOS HyperFluent artwork pinned at upstream commit
